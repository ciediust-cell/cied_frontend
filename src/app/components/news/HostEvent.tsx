  ...
  return (
    <>
              ...
              <div className="space-y-6">
                ...
                <div className="pt-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed mb-6">
                    Our multipurpose hall can accommodate up to 200 attendees
                    with flexible seating arrangements. We provide complete AV
                    support, high-speed internet, refreshment facilities, and
                    dedicated event coordination assistance.
                  </p>
      ...
      <QuickEnquiryModal
        ...
        title="Host an Event at CIED"
        description="Share your event details and our team will get in touch."
        subject="event"
        messagePlaceholder="Tell us about your event type, expected attendees, and preferred dates."
