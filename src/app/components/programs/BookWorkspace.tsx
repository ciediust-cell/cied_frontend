            ...
            <div className="space-y-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Conference rooms with AV equipment for presentations and
                        discussions
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <div className="text-foreground">Collaboration Areas</div>
                      <p className="text-sm text-muted-foreground">
              ...
              <div className="pt-4">
                ...
                <p className="text-muted-foreground leading-relaxed mb-6">
                  ...
                  Flexible booking options including hourly, daily, and monthly
                  plans.
                </p>
